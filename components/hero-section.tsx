  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Green Gradient Orbs with improved animations */}
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center space-y-8">
        ...
        >
          <Sparkles size={16} className="text-green-500 animate-spin" style={{ animationDuration: "3s" }} />
          ...
          <h1 className="font-headline text-5xl md:text-7xl font-bold text-foreground tracking-tight">
            ...
            <span className="block h-24 md:h-32 relative overflow-hidden">
              <span className="inline-block animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                <span className="gradient-text">Materials Science</span>
              </span>
            </span>
          </h1>
        ...
        {/* Trust Indicator with staggered animation */}
        <div
        ...
        >
          ...
          <div className="flex justify-center items-center gap-6 flex-wrap">
            {["Lagos", "Abuja", "Port Harcourt", "Kano", "Ibadan"].map((city, i) => (
              <div
                key={city}
                className="text-xs font-medium text-muted-foreground px-4 py-2 rounded-lg bg-white/5 border border-green-900/20 backdrop-blur-sm transition-all duration-300 hover:border-green-500/50 hover:bg-green-900/10"
                style={{
                  animation: isVisible
                    ? `floatIn 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) ${i * 100}ms forwards`
                    : "none",
